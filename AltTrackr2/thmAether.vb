...
Module Helpers
    ...
    Public Sub FillRoundRect(G As Graphics, R As Rectangle, Curve As Integer, B As Brush)
    ...
    Public Sub DrawRoundRect(G As Graphics, R As Rectangle, Curve As Integer, PP As Pen)
...
Public Class AetherCircular
    ...
    Public Property ShowMax As Boolean = False
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        If HatchBrush Then
            ...
            End Using
        Else
            Using P1 As New Pen(HatchPrimary, 4), P2 As New Pen(Border, 4)
                G.DrawArc(P1, New Rectangle(2, 2, Width - 5, Height - 5), -90, ProgressAngle)
                G.DrawArc(P2, New Rectangle(2, 2, Width - 5, Height - 5), ProgressAngle - 90, RemainderAngle)
            End Using
        End If
        ...
        If Percent Then
            ...
            Using F1 As New Font("Segoe UI", 9, FontStyle.Bold)
                ...
                If ShowMax Then
                    Progress_Text = Progress & "/" & Max & " " & PostText
                Else
                    Progress_Text = Progress & PostText
                End If

                If ExceedingLimits Then
                    CenterString(G, Progress_Text & ExceedingSign, F1, Color.FromArgb(100, 100, 100), New Rectangle(1, 1, Width, Height + 1))
                Else
                    CenterString(G, Progress_Text, F1, Color.FromArgb(100, 100, 100), New Rectangle(1, 1, Width, Height + 1))
                End If
        ...
        If Checked Then
            ...
            If Enabled Then
                ...
                If HatchBrush Then
                    ...
                    End Using
                Else
                    Using B1 As New Pen(ColorFromHex("#5B606F")), P1 As New Pen(ColorFromHex("#474C5A"))
                        G.FillRectangle(B1.Brush, New Rectangle(4, 4, 10, 10))
                        DrawRoundRect(G, New Rectangle(4, 4, 10, 10), 3, P1)
                    End Using
                End If
            ...
            Else
                ...
                If HatchBrush Then
                    ...
                    End Using
                Else
                    Using B1 As New Pen(ColorFromHex("#8C92A1")), P1 As New Pen(ColorFromHex("#797E8C"))
                        G.FillRectangle(B1.Brush, New Rectangle(4, 4, 10, 10))
                        DrawRoundRect(G, New Rectangle(4, 4, 10, 10), 3, P1)
                    End Using
                End If
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        If Checked Then
            ...
            If Enabled Then
                ...
                Else
                    Using B1 As New Pen(ColorFromHex("#5B606F")), P1 As New Pen(ColorFromHex("#474C5A"))
                        G.FillEllipse(B1.Brush, New Rectangle(4, 4, 10, 10))
                        G.DrawEllipse(P1, New Rectangle(4, 4, 10, 10))
                    End Using
                End If
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
            ...
            Select Case State
                ...
                Case MouseState.Over
                    ...
                    Using B1 As New SolidBrush(ColorFromHex("#FDFDFD"))
                        FillRoundRect(G, New Rectangle(0, 0, Width - 1, Height - 1), 3, B1)
                    End Using
        ...
        Else
            ...
            Using B1 As New SolidBrush(ColorFromHex("#F2F2F2")), P1 As New Pen(ColorFromHex("#DCDCDC")), F1 As New Font("Segoe UI", 9)
                FillRoundRect(G, New Rectangle(0, 0, Width - 1, Height - 1), 6, B1)
